...
#define ANT_SNR_RAW_MIN -100 // absolute min measured SNR
#define ANT_SNR_RAW_MAX 200	 // absolute maximum measured SNR
...
#define OUTLIER_FACTOR 100			// sigma factor SNR outlier factor
